...
## Pip Install
	...
	pip3 install NlpToolkit-InformationRetrieval
...
A directory called Corpus will be created. Or you can use below link for exploring the code:
	...
	git clone https://github.com/olcaytaner/InformationRetrieval-Py.git
...
* Choose `InformationRetrieval-Py` file
